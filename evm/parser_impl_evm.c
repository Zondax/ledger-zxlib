...
extern parser_evm_error_t printGenericAppSpecific(const parser_evm_context_t *ctx, const eth_tx_t *ethTxObj,
                                                  uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
                                                  uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount);
extern parser_evm_error_t printERC20TransferAppSpecific(const parser_evm_context_t *ctx, const eth_tx_t *ethTxObj,
...
static parser_evm_error_t printERC20Transfer(const parser_evm_context_t *ctx, uint8_t displayIdx, char *outKey,
...
static parser_evm_error_t printGeneric(const parser_evm_context_t *ctx, uint8_t displayIdx, char *outKey,
                                       uint16_t outKeyLen, char *outVal, uint16_t outValLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    if (outKey == NULL || outVal == NULL || pageCount == NULL) {
        return parser_evm_unexpected_error;
...
parser_evm_error_t _getNumItemsEth(uint8_t *numItems) { return getNumItemsEthAppSpecific(&eth_tx_obj, numItems); }
